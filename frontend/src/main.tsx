...
import { getProfile, getTrainingSummary, saveTrainingAnswer, submitAssessment as saveAssessment } from './lib/api';
...
function App() {
  ...
  return <main className="workspace">
    ...
    {view === 'overview' && <Overview displayName={displayName} completed={completed} riskProfile={riskProfile} trainingSummary={trainingSummary} onAssessment={() => setView('assessment')} onTraining={() => setView('training')} />}
    ...
    {view === 'training' && <TrainingView answer={trainingAnswer} onAnswer={handleTrainingAnswer} />}
